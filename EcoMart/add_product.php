...
check_login();
    ...
    if ($_SERVER['REQUEST_METHOD'] == 'POST') {
        ...
        if (is_array($_FILES['image']['name'])) {
            ...
            $product_id = $Product->addProduct($name, $description, $price, $stock_quantity, $category_id, $primary_image_url);
            ...
            foreach ($_FILES['image']['name'] as $key => $image_name) {
                ...
                if (!empty($image_name)) {
                    ...
                    $ProductImage->saveImageToProductImages($product_id, $image_url);
